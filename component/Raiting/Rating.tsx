...
export const Rating = ({isEditable = false, rating, setRating, ...props}: RatingProps): JSX.Element => {
    ...
    const constructRating = (r: number) => {
        ...
        const updateArray = ratingArray.map((el, i) => {
            ...
            const onKeyDownHandler = (e: KeyboardEvent<SVGSVGElement>, i: number) => {
                if (e.code === 'Space') {
                    onClickHandler(i)
                }
            }
            ...
            return (
                <svg
                    ...
                    onKeyDown={(e) => onKeyDownHandler(e, i + 1)}
                    fill={(i < r) ? s.filled : "#E2E2E2"}
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
